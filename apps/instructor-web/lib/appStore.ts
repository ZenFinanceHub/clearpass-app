...
// Both store listings are live as of Sept 2026. Same shape as mobile's
...
// link that 404s", not the other way round — set NEXT_PUBLIC_STORE_LISTINGS_LIVE
// to "true" in Vercel's production env vars to flip this on.
