...
export const attitudeQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
    "Blue dashboard telltale icon showing headlamp beam lines, indicating the main-beam headlights are on",
    "Green dashboard telltale icon showing a left-pointing arrow, indicating a direction indicator is on",
    "Orange dashboard telltale icon showing an exclamation mark inside a circle bracketed by brake-pad shapes, indicating a brake system warning",
    "Red dashboard telltale icon showing a white triangle outline, indicating a general warning light",
    ],
    correctIndex: 0,
    optionImages: [
      "https://secavejbaapapvvqbwed.supabase.co/storage/v1/object/public/question-images/TS4035f.png",
      "https://secavejbaapapvvqbwed.supabase.co/storage/v1/object/public/question-images/TS4035c.png",
      "https://secavejbaapapvvqbwed.supabase.co/storage/v1/object/public/question-images/TS4035i.png",
      "https://secavejbaapapvvqbwed.supabase.co/storage/v1/object/public/question-images/TS4039.png",
    ],
