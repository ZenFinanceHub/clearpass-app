...
export const otherTypesQuestions: Question[] = [
  {
    ...
    options: [
    "Red-bordered white triangle warning sign showing a black windsock blowing sideways, warning of side winds",
    "Red circular sign with a black arrow bent left crossed out by a red diagonal line, meaning no left turn",
    ...
    correctIndex: 0,
    optionImages: [
      "https://secavejbaapapvvqbwed.supabase.co/storage/v1/object/public/question-images/TS4518.png",
      "https://secavejbaapapvvqbwed.supabase.co/storage/v1/object/public/question-images/TS4664.png",
